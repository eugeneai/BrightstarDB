    ...
    public abstract class OptimisticLockingTestsBase
    {
        ...
        protected virtual void TestSimplePropertyRefreshWithClientWins()
        {
            using (var context1 = NewContext())
            {
                ...
                using (var context2 = NewContext())
                {
                    ...
                    Assert.Equal(21, alice2.Age);
                    alice2.Age = 22;
                    context2.SaveChanges();
                }

                alice1.Age = 20;
                Assert.Throws<TransactionPreconditionsFailedException>(() => context1.SaveChanges());
        ...
        public void TestRelatedObjectRefreshWithClientWins()
        {
            using (var context1 = NewContext())
            {
                ...
                using (var context3 = NewContext())
                {
                    var alice3 = context3.Persons.FirstOrDefault(p => p.Id.Equals(alice1.Id));
                    Assert.NotNull(alice3);
                    Assert.NotNull(alice3.MainSkill);
                    Assert.Equal("Project Management", alice3.MainSkill.Name);
                }
            }
        }
        ...
        public void TestRelatedObjectRefreshWithStoreWins()
        {
            using (var context1 = NewContext())
            {
                ...
                Assert.Throws<TransactionPreconditionsFailedException>(() => context1.SaveChanges());
                context1.Refresh(RefreshMode.StoreWins, alice1);
                Assert.Equal("Web Design", alice1.MainSkill.Name);
                context1.SaveChanges();
                ...
                using (var context3 = NewContext())
                {
                    ...
                    Assert.NotNull(alice3);
                    Assert.NotNull(alice3.MainSkill);
                    Assert.Equal("Web Design", alice3.MainSkill.Name);
                }
            }
        }
        ...
        public void TestLiteralCollectionRefreshWithClientWins()
        {
            using (var context1 = NewContext())
            {
                ...
                using (var context3 = NewContext())
                {
                    ...
                    Assert.Equal(2, person3.MboxSums.Count);
                    Assert.True(person3.MboxSums.Contains("sum2"));
                    Assert.True(person3.MboxSums.Contains("sum4"));
                }
            }
        }
        ...
        public void TestLiteralCollectionRefreshWithStoreWins()
        {
            using (var context1 = NewContext())
            {
                ...
                Assert.Equal(2, person1.MboxSums.Count);
                Assert.True(person1.MboxSums.Contains("sum2"));
                Assert.True(person1.MboxSums.Contains("sum3"));
                context1.SaveChanges();
                ...
                using (var context3 = NewContext())
                {
                    ...
                    Assert.Equal(2, person3.MboxSums.Count);
                    Assert.True(person3.MboxSums.Contains("sum2"));
                    Assert.True(person3.MboxSums.Contains("sum3"));
                }
            }
        }
        ...
        public void TestObjectCollectionRefreshWithClientWins()
        {
            using (var context1 = NewContext())
            {
                ...
                using (var context3 = NewContext())
                {
                    var alice3 = context3.Persons.FirstOrDefault(p => p.Id.Equals(alice1.Id));
                    Assert.NotNull(alice3);
                    Assert.Equal(2, alice3.Skills.Count);
                    Assert.True(alice3.Skills.Any(s => s.Id.Equals(programming1.Id)),
                        "Could not find Programming skill after save");
                    Assert.True(alice3.Skills.Any(s => s.Id.Equals(scrum1.Id)),
        ...
        public void TestObjectCollectionRefreshWithStoreWins()
        {
            using (var context1 = NewContext())
            {
                ...
                Assert.Throws<TransactionPreconditionsFailedException>(() => context1.SaveChanges());
                context1.Refresh(RefreshMode.StoreWins, alice1);
                Assert.Equal(2, alice1.Skills.Count);
                Assert.True(alice1.Skills.Any(s => s.Id.Equals(programming1.Id)));
                Assert.True(alice1.Skills.Any(s => s.Id.Equals(projMgt1.Id)));
                context1.SaveChanges();
                ...
                using (var context3 = NewContext())
                {
                    ...
                    Assert.True(alice3.Skills.Any(s => s.Id.Equals(programming1.Id)),
                        "Could not find Programming skill after save");
                    Assert.True(alice3.Skills.Any(s => s.Id.Equals(projMgt1.Id)),
        ...
        public void MultiLiteralPropertyRefreshStoreWins()
        {
            using (var context1 = NewContext())
            {
                ...
                Assert.Equal(22, alice.Age);
                Assert.Equal(41, bob.Age);
                context1.SaveChanges();
