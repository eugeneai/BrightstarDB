...
{
    public sealed class SparqlUpdateModule : NancyModule
    {
        ...
        {
            this.RequiresBrightstarStorePermission(permissionsProvider, get: StorePermissions.SparqlUpdate,
                post: StorePermissions.SparqlUpdate);
